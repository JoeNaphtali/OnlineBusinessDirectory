...
<body id="page-top">
		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4">
					<h1 class="h3 mb-0 text-gray-800">Analytics for <?php echo $row['listing_name'];?></h1>
				</div>
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									...
									?>	
									<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row_visits['visits'];?></div>
								</div>
								<div class="col-auto">
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									...
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $number_of_reviews ?></div>
										</div>
									</div>
								</div>
								<div class="col-auto">
  ...
  <script>
	...
	data: {
		...
		pointHitRadius: 10,
		pointBorderWidth: 2,
		data: [<?php echo $row_visits['sun'];?>, 
		<?php echo $row_visits['mon'];?>, 
		<?php echo $row_visits['tue'];?>, 
		<?php echo $row_visits['wed'];?>, 
		<?php echo $row_visits['thu'];?>, 
		<?php echo $row_visits['fri'];?>, 
		<?php echo $row_visits['sat'];?>],
		}],
	},
	options: {
  ...
  <script>
	...
	data: {
		...
		datasets: [{
		data: [<?php echo $row_visits['mobile'];?>, 
		<?php echo $row_visits['computer'];?>, 
		<?php echo $row_visits['other'];?>],
  ...
  <script>
	...
	data: {
		...
		borderColor: "#4e73df",
		data: [<?php echo $row['website_link_clicks']; ?>, 
		<?php echo $row['facebook_link_clicks']; ?>, 
		<?php echo $row['twitter_link_clicks']; ?>, 
		<?php echo $row['instagram_link_clicks']; ?>],
		}],
	},
	options: {
		maintainAspectRatio: false,
